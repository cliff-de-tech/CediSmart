...
from sqlalchemy import Boolean, Integer, String, ForeignKey, UniqueConstraint, text
...
class Category(TimestampMixin, Base):
    ...
    color: Mapped[Optional[str]] = mapped_column(String(7), nullable=True)  # Hex: #FF6B35
